    ...
    <div className="testimonial p-3">
      <figure>
        <span className="source-icon">
          ...
          <img
            src="https://placeimg.com/45/45/people"
            alt=""
        ...
        <figcaption>
          ...
          <cite className="company">My Company</cite>,
          <cite className="company">2 mins ago</cite>
          <blockquote className="ml-auto">
            Reprehenderit eu nulla nostrud ad consequat labore cupidatat
            adipisicing elit id reprehenderit anim.
          </blockquote>
        </figcaption>
      </figure>
    </div>
